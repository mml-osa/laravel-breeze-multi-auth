...
{{--									<p class="text-muted mb-0">Get the help you need in using this platform!</p>--}}
{{--								</div>--}}
{{--							--}}
{{--							</div><!-- end card header -->--}}
{{--						</div>--}}
							...
							<div class="row">
								<div class="col-xxl-5 align-self-center">
									<div class="py-4">
										...
										<p class="text-info fs-15 mt-3">If you can not find answer to your question in our FAQ, you can always contact us or email us. We will answer you shortly!</p>
										<div class="hstack flex-wrap gap-2">
											...
											<button type="button" class="btn btn-info btn-label rounded-pill"><i class="ri-ticket-2-line label-icon align-middle rounded-pill fs-16 me-2"></i> Submit A Ticket</button>
										</div>
									</div>
								</div>
								...
								<div class="accordion accordion-border-box" id="manageaccount-accordion">
									...
									<div class="accordion-item">
										<h2 class="accordion-header" id="manageaccount-headingTwo">
											<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#manageaccount-collapseTwo" aria-expanded="true" aria-controls="manageaccount-collapseTwo">
												Where does it come from ?
											</button>
										</h2>
								...
								<div class="accordion accordion-border-box" id="privacy-accordion">
									<div class="accordion-item">
										<h2 class="accordion-header" id="privacy-headingOne">
											<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#privacy-collapseOne" aria-expanded="true" aria-controls="privacy-collapseOne">
												Why do we use it ?
											</button>
										</h2>
