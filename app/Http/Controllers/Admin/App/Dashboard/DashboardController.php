...
namespace App\Http\Controllers\Admin\App\Dashboard;
...
class DashboardController extends Controller
{
    ...
    public function index()
    {
			...
			$seniorHighSchools = SeniorHighSchool::all();
			$universities = Universities::all();
			return view('admin.app.dashboard.index')
				->with('students', $students)
				->with('seniorHighSchools', $seniorHighSchools)
